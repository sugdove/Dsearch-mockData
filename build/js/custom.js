...
if (typeof NProgress != 'undefined') {
    ...
    //采集状态中js
    function init_Acquisition_state() {
    ...
    //点击搜索跳转到搜索界面
     function init_search() {
    	$(".search").click(function () {
			var param = $(this).parent().find("input[type='text']").val();
			if(param===""){
            alert("搜索值不能为空")
			}
			else{
				window.location.href = encodeURI("Acquisition_result.html?q="+param);
			}
			return false
        })
}
